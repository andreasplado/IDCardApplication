...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            this.applicationVersion = "ai.Applicant.ver";
            this.applicationBuild = "ai.Applicant.build";
            this.applicationTypeId = "ai.Applicant.typeId";
            ...
            this.userAccountAcquisitionDate = "ai.Applicant.accountAcquisitionDate";
            this.userAccountId = "ai.Applicant.accountId";
            this.userAgent = "ai.Applicant.userAgent";
            this.userId = "ai.Applicant.id";
            this.userStoreRegion = "ai.Applicant.storeRegion";
            this.userAuthUserId = "ai.Applicant.authUserId";
            this.userAnonymousUserAcquisitionDate = "ai.Applicant.anonUserAcquisitionDate";
            this.userAuthenticatedUserAcquisitionDate = "ai.Applicant.authUserAcquisitionDate";
        ...
        (function (Context) {
            ...
            var User = (function () {
                ...
                User.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
                    ...
                    if (isInvalidInput) {
                        ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Setting auth Applicant context failed. " + "Application auth/account id should be of type string, and not contain commas, semi-colons, equal signs, spaces, or vertical-bars.");
                        return;
                    }
        ...
        var AppInsights = (function () {
            ...
            AppInsights.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Setting auth Applicant context failed. " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.clearAuthenticatedUserContext = function () {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Clearing auth Applicant context failed. " + ApplicationInsights.Util.dump(e));
                }
            };
            ...
            function Initialization(snippet) {
                ...
                if (config && !config.instrumentationKey) {
                    ...
                    if (config["iKey"]) {
                        ...
                        throw new Error("Cannot load Applicant Insights SDK, no instrumentationKey was provided.");
                    }
                }
